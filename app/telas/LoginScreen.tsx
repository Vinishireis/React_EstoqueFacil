  ...
  return (
    <View className="bg-white h-full w-full">
      ...
      <View className="flex-row justify-around w-full absolute">
        ...
        {/* Título e Formulário*/}
        <View className="h-full w-full flex justify-around pt-40 pb-50">
          {/* Título */}
          ...
          <View className="flex items-center mx-4 space-y-4">
            ...
            <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} className="w-full">
              <TouchableOpacity
                className="w-full bg-sky-400 p-3 rounded-2xl mb-3">
                    <Text className="text-xl font-bold text-white text-center" onPress={()=> navigation.push('OrdersScreen')}>Login</Text>
                </TouchableOpacity>
            </Animated.View>
            ...
            <Animated.View entering={FadeInDown.delay(600).duration(1000).springify()} className="flex-row justify-center">
              ...
              <TouchableOpacity onPress={()=> navigation.push('SignUp')}>
                <Text className="text-sky-600">Inscreva-se</Text>
              </TouchableOpacity>
            </Animated.View>
